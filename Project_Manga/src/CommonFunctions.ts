...
export const createRandomMangaData = (randomData: any): MangaDetails => ({
  ...
  mangaStatus: randomData.data.attributes.status || '',
  mangaState: randomData.data.attributes.state || '',
  mangaYear: randomData.data.attributes.year || 0,
  mangaTags: randomData.data.attributes.tags || [],
...
export const createAllMangas = (allMangas: any): MangaDetails[] => {
  ...
  allMangas.data.map((manga: any) =>
    mangas.push({
      ...
      mangaState: manga.attributes.state || '',
      mangaYear: manga.attributes.year || 0,
